...
optimizer_ft = optim.SGD([
    {'params': base_params},
    {'params': model_ft.classifier.parameters(), 'lr': 0.05}
...
orginin['tags'] = scores
orginin.to_csv(
    '/mnt/home/dunan/Learn/Kaggle/planet_amazon/pytorch_densenet161_transfer_learning_multi_tta.csv',
    index=False)
...
valid_df.to_csv(
    '/mnt/home/dunan/Learn/Kaggle/planet_amazon/pytorch_densenet161_transfer_learning_multi_tta_valid.csv',
    index=False)
